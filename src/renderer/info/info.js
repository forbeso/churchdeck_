    ...
    <div className="card-section d-flex animate__animated animate__fadeIn text-center justify-content-center">
      ...
      <div className="yellow-bar"></div>
        ...
        <div className="card-title">
          ...
          <small>A church loving God, loving others, and serving the world</small>
        </div>
        ...
        <div className="church-info">
            ...
            <p>
              <strong>Social Media Handles:</strong> Facebook: @abundantlifechurch, Instagram: @abundantlife.ministries
            </p>
            <p>
              <strong>Ministries:</strong> Youth Ministry, Women's Ministry, Men's Fellowship, Community Outreach
            </p>
